...
```
        kubectl / kubelet / controller
                    ...
                    ▼
          ┌─────────────────────┐
          │   VIP 192.168.128.238│  ← Keepalived 漂移
          └─────────┬───────────┘
                    │
               HAProxy :6443
          ┌─────────┼───────────┐
...
frontend k8s-apiserver
    bind 192.168.128.238:6443

backend k8s-apiserver
    server master01 192.168.128.230:6443 check
    server master02 192.168.128.231:6443 check
    server master03 192.168.128.232:6443 check
```
...
```
--kubeconfig
server: https://192.168.128.238:6443
```
...
```
--advertise-address=192.168.128.230
```
