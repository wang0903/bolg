...
#             Once you get things working, you should remove that whole line altogether.
          ...
          ports:
            ...
            - name: admin
              containerPort: 8080
      # 修改为指定 运行 traefik controller 节点
      nodeName: k8s-n4
...
### kubernetes-crd-definition-v1代码
