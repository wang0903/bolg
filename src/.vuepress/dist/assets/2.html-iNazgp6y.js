import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,a as e}from"./app-HMLpIP8o.js";const i={},t=e(`<h1 id="docker安装nginx服务器-代理访问minio" tabindex="-1"><a class="header-anchor" href="#docker安装nginx服务器-代理访问minio" aria-hidden="true">#</a> docker安装nginx服务器,代理访问minio</h1><h3 id="_1-拉取nginx镜像-创建docker-compose-yml" tabindex="-1"><a class="header-anchor" href="#_1-拉取nginx镜像-创建docker-compose-yml" aria-hidden="true">#</a> 1. 拉取nginx镜像,创建docker-compose.yml</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>
