import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,a as e}from"./app-HMLpIP8o.js";const t={},p=e(`<h1 id="安装rocketmq" tabindex="-1"><a class="header-anchor" href="#安装rocketmq" aria-hidden="true">#</a> 安装rocketmq</h1><h2 id="系统解耦-decoupling" tabindex="-1"><a class="header-anchor" href="#系统解耦-decoupling" aria-hidden="true">#</a> <strong>系统解耦（Decoupling）</strong></h2><ul><li><strong>问题</strong>： <ul><li>传统系统 A 调用系统 B，直接依赖。</li><li>如果 B 宕机或响应慢，A 也会受影响。</li></ul></li><li><strong>MQ 解决方式</strong>： <ul><li>生产者把消息发到 MQ，消费者自己去 MQ 消费。</li><li>生产者不关心谁消费，也不关心消费速度。</li></ul></li><li><strong>制造行业示例</strong>： <ul><li>生产线设备上报状态 → MQ → MES 或报警系统消费</li><li>即使 MES 暂时停机，设备依然可以上报消息，系统不会崩。</li></ul></li></ul><hr><h2 id="流量削峰填谷-peak-shaving" tabindex="-1"><a class="header-anchor" href="#流量削峰填谷-peak-shaving" aria-hidden="true">#</a> <strong>流量削峰填谷（Peak Shaving）</strong></h2><ul><li><strong>问题</strong>： <ul><li>ERP 或设备在短时间内产生大量消息。</li><li>数据库或后端处理系统瞬间承受不了。</li></ul></li><li><strong>MQ 解决方式</strong>： <ul><li>消息先存入 MQ 队列（缓冲区）。</li><li>消费端按自己的能力慢慢处理消息。</li></ul></li><li><strong>制造行业示例</strong>： <ul><li>高峰期下 1000 条订单 → MQ 队列缓冲 → MES 慢慢生成工单 → 写数据库</li></ul></li></ul><hr><h2 id="异步处理-asynchronous-processing" tabindex="-1"><a class="header-anchor" href="#异步处理-asynchronous-processing" aria-hidden="true">#</a> <strong>异步处理（Asynchronous Processing）</strong></h2><ul><li><strong>问题</strong>： <ul><li>某些操作不需要立即完成，但又必须可靠执行。</li><li>如果同步处理，主流程会被阻塞。</li></ul></li><li><strong>MQ 解决方式</strong>： <ul><li>生产者发送消息后立即返回。</li><li>消费端异步处理耗时任务。</li></ul></li><li><strong>制造行业示例</strong>： <ul><li>设备报警 → MQ → 消费端异步处理短信/邮件通知 → 不影响设备采集</li></ul></li></ul><hr><h2 id="提高可靠性-reliability-retry" tabindex="-1"><a class="header-anchor" href="#提高可靠性-reliability-retry" aria-hidden="true">#</a> <strong>提高可靠性（Reliability &amp; Retry）</strong></h2><ul><li><strong>问题</strong>： <ul><li>网络异常或消费端异常可能导致消息丢失。</li><li>直接调用接口或写数据库，如果失败，消息就丢了。</li></ul></li><li><strong>MQ 解决方式</strong>： <ul><li>消息持久化到 Broker（CommitLog），保证不会丢失。</li><li>支持消费失败重试、事务消息。</li></ul></li><li><strong>制造行业示例</strong>： <ul><li>关键报警或订单消息即使消费失败，MQ 会重试，保证最终处理成功。</li></ul></li></ul><hr><h2 id="mq总结" tabindex="-1"><a class="header-anchor" href="#mq总结" aria-hidden="true">#</a> MQ总结</h2><blockquote><p><strong>MQ 设计出来是为了解耦系统、削峰填谷、异步处理和保证消息可靠性</strong>。 换句话说，它解决的是<strong>高并发、高耦合、同步阻塞和数据可靠性</strong>的问题，而不是用来存储业务数据。</p></blockquote><hr><h2 id="编写docker-compose-yml" tabindex="-1"><a class="header-anchor" href="#编写docker-compose-yml" aria-hidden="true">#</a> 编写docker-compose.yml</h2><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">services</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="创建topic名称命令" tabindex="-1"><a class="header-anchor" href="#创建topic名称命令" aria-hidden="true">#</a> 创建topic名称命令</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> <span class="token builtin class-name">exec</span> <span class="token parameter variable">-it</span> rmqbroker <span class="token function">sh</span> mqadmin updateTopic <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="原理图片" tabindex="-1"><a class="header-anchor" href="#原理图片" aria-hidden="true">#</a> 原理图片</h2><figure><img src="https://rocketmq.apache.org/assets/images/mainarchi-9b036e7ff5133d050950f25838367a17.png" alt="Domain Model - RocketMQ" tabindex="0" loading="lazy"><figcaption>Domain Model - RocketMQ</figcaption></figure><h2 id="核心角色" tabindex="-1"><a class="header-anchor" href="#核心角色" aria-hidden="true">#</a> 核心角色</h2><table><thead><tr><th>角色</th><th>作用</th><th>说明</th></tr></thead><tbody><tr><td><strong>NameServer</strong></td><td>注册中心</td><td>Broker 的地址注册、Topic 路由发现</td></tr><tr><td><strong>Broker</strong></td><td>消息存储/转发服务器</td><td>真正存消息（基于 CommitLog）</td></tr><tr><td><strong>Producer</strong></td><td>消息生产者</td><td>发送消息到 Broker</td></tr><tr><td><strong>Consumer</strong></td><td>消息消费者</td><td>从 Broker 拉取消息</td></tr></tbody></table><h2 id="rocketmq-的消息流转原理-非常重要" tabindex="-1"><a class="header-anchor" href="#rocketmq-的消息流转原理-非常重要" aria-hidden="true">#</a> RocketMQ 的消息流转原理（非常重要）</h2><blockquote><p>① Topic 路由发现</p></blockquote><blockquote><p>Producer → NameServer Consumer → NameServer （拿到 Broker 的地址和 Topic 的队列列表）</p></blockquote><blockquote><p>② Producer 发送消息</p></blockquote><blockquote><p>Producer 会从路由表中选择一个 Queue（比如 round &gt; robin）</p></blockquote><blockquote><p>将消息发送到对应 Broker</p></blockquote><blockquote><p>Broker 写入 CommitLog（顺序写），性能非常高</p></blockquote><blockquote><p>③ Consumer 拉取消息（Push 其实也是拉）</p></blockquote><blockquote><p>Consumer 每隔一段时间向 Broker 拉取消息（Pull）</p></blockquote><blockquote><p>框架将其封装成 Push 形式（回调）</p></blockquote><blockquote><p>Consumer 还会保存消费进度（Offset）</p></blockquote><hr><h2 id="示例-java" tabindex="-1"><a class="header-anchor" href="#示例-java" aria-hidden="true">#</a> 示例(java)</h2><h3 id="message-消息" tabindex="-1"><a class="header-anchor" href="#message-消息" aria-hidden="true">#</a> Message 消息</h3><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@Data</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="smssendconsumer-消费者" tabindex="-1"><a class="header-anchor" href="#smssendconsumer-消费者" aria-hidden="true">#</a> SmsSendConsumer 消费者</h3><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SmsSendConsumer</span> <span class="token keyword">implements</span> <span class="token class-name">RocketMQListener</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">SmsSendMessage</span><span class="token punctuation">&gt;</span></span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="测试" tabindex="-1"><a class="header-anchor" href="#测试" aria-hidden="true">#</a> 测试</h3><div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code>### 请求 /system/sms-template/send-sms 接口 =&gt; 成功
