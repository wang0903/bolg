import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as i,c,a as n,b as s,e as o,d as a}from"./app-af1K1DCR.js";const p={},d=a(`<h1 id="docker安装mysql8-0" tabindex="-1"><a class="header-anchor" href="#docker安装mysql8-0" aria-hidden="true">#</a> docker安装MySQL8.0</h1><h3 id="_1、下载mysql" tabindex="-1"><a class="header-anchor" href="#_1、下载mysql" aria-hidden="true">#</a> 1、下载MySQL</h3><p><strong>注意：在修改数据库配置文件时，也要修改本文档（要让服务器配置文件和文档同步）</strong></p><p><strong>/home/mes/mydata/mysql</strong> 数据和配置文件在这个目录下面</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>docker pull mysql
