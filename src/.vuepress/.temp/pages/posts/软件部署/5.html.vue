<template><div><h1 id="外网访问内网vpn" tabindex="-1"><a class="header-anchor" href="#外网访问内网vpn" aria-hidden="true">#</a> 外网访问内网vpn</h1>
<h3 id="wg-easy官网-https-github-com-wg-easy-wg-easy" tabindex="-1"><a class="header-anchor" href="#wg-easy官网-https-github-com-wg-easy-wg-easy" aria-hidden="true">#</a> [wg-easy官网][https://github.com/wg-easy/wg-easy]</h3>
<h3 id="_1、创建docker-compose-yml文件-这种方式安装基础环境要安装docker和docker-compose-记得将服务器的ip映射到外网-映射端口为51820" tabindex="-1"><a class="header-anchor" href="#_1、创建docker-compose-yml文件-这种方式安装基础环境要安装docker和docker-compose-记得将服务器的ip映射到外网-映射端口为51820" aria-hidden="true">#</a> 1、<strong>创建docker-compose.yml文件，这种方式安装基础环境要安装docker和docker-compose</strong>，记得将服务器的IP映射到外网，映射端口为51820</h3>
...
<span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">wg-easy</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">environment</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> WG_HOST=192.168.1.1 <span class="token comment">#公网IP</span>
      <span class="token punctuation">-</span> PASSWORD=123456 <span class="token comment">#默认登录密码</span>
      <span class="token punctuation">-</span> WG_DEFAULT_ADDRESS=192.168.5.x <span class="token comment">#默认生成的网段,需要写成公司内部的网段，最好是单独分配一个网段给</span>
      <span class="token punctuation">-</span> WG_DEFAULT_DNS=192.168.1.4  <span class="token comment">#网络的dns</span>
      <span class="token punctuation">-</span> WG_ALLOWED_IPS=192.168.1.0/24<span class="token punctuation">,</span> 192.168.2.0/24<span class="token punctuation">,</span>192.168.3.0/24 <span class="token comment">#允许那些公司内部网段被访问</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2、配置参数" tabindex="-1"><a class="header-anchor" href="#_2、配置参数" aria-hidden="true">#</a> 2、配置参数</h3>
<figure><img src="@source/.vuepress/public/assets/images/wg-easy/14.png" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure>
<h3 id="_3、-pc端软件下载-https-download-wireguard-com-windows-client" tabindex="-1"><a class="header-anchor" href="#_3、-pc端软件下载-https-download-wireguard-com-windows-client" aria-hidden="true">#</a> 3、[PC端软件下载][https://download.wireguard.com/windows-client/]</h3>
<figure><img src="@source/.vuepress/public/assets/images/wg-easy/2.png" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure>
<h3 id="_4、-安卓下载-https-www-wireguard-com-install" tabindex="-1"><a class="header-anchor" href="#_4、-安卓下载-https-www-wireguard-com-install" aria-hidden="true">#</a> 4、[安卓下载][https://www.wireguard.com/install/]</h3>
<figure><img src="@source/.vuepress/public/assets/images/wg-easy/3.png" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure>
<h3 id="_5、苹果手机和苹果电脑自行到苹果商店下载" tabindex="-1"><a class="header-anchor" href="#_5、苹果手机和苹果电脑自行到苹果商店下载" aria-hidden="true">#</a> 5、苹果手机和苹果电脑自行到苹果商店下载</h3>
<h3 id="_6、容器安装" tabindex="-1"><a class="header-anchor" href="#_6、容器安装" aria-hidden="true">#</a> 6、容器安装</h3>
<figure><img src="@source/.vuepress/public/assets/images/wg-easy/4.png" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure>
<p>启动成功</p>
<figure><img src="@source/.vuepress/public/assets/images/wg-easy/5.png" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure>
<h3 id="_7、访问web端" tabindex="-1"><a class="header-anchor" href="#_7、访问web端" aria-hidden="true">#</a> 7、访问web端</h3>
<figure><img src="@source/.vuepress/public/assets/images/wg-easy/6.png" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure>
<figure><img src="@source/.vuepress/public/assets/images/wg-easy/7.png" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure>
<h3 id="_8、创建客户端密钥" tabindex="-1"><a class="header-anchor" href="#_8、创建客户端密钥" aria-hidden="true">#</a> 8、创建客户端密钥</h3>
<figure><img src="@source/.vuepress/public/assets/images/wg-easy/9.png" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure>
<h3 id="_9、下载密钥" tabindex="-1"><a class="header-anchor" href="#_9、下载密钥" aria-hidden="true">#</a> 9、下载密钥</h3>
<figure><img src="@source/.vuepress/public/assets/images/wg-easy/10.png" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure>
<p><img src="@source/.vuepress/public/assets/images/wg-easy/11.png" alt="Alt text" loading="lazy">
导入成功</p>
<figure><img src="@source/.vuepress/public/assets/images/wg-easy/13.png" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure>
<figure><img src="@source/.vuepress/public/assets/images/wg-easy/14.png" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure>
<h3 id="_10、配置文件wg0-conf" tabindex="-1"><a class="header-anchor" href="#_10、配置文件wg0-conf" aria-hidden="true">#</a> 10、配置文件wg0.conf</h3>
...
Address <span class="token operator">=</span> <span class="token number">192.168</span>.5.1/24 <span class="token comment">#这个地方记得写成你自己要分配的IP网段</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_11、配置文件wg0-json" tabindex="-1"><a class="header-anchor" href="#_11、配置文件wg0-json" aria-hidden="true">#</a> 11、配置文件wg0.json</h3>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token property">"server"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token property">"address"</span><span class="token operator">:</span> <span class="token string">"192.168.5.1"</span> #这个地方也改成你自己要分配的IP
