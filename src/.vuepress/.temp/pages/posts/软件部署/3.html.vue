<template><div><h1 id="docker安装mysql8-0" tabindex="-1"><a class="header-anchor" href="#docker安装mysql8-0" aria-hidden="true">#</a> docker安装MySQL8.0</h1>
<h3 id="_1、下载mysql" tabindex="-1"><a class="header-anchor" href="#_1、下载mysql" aria-hidden="true">#</a> 1、下载MySQL</h3>
<p><strong>注意：在修改数据库配置文件时，也要修改本文档（要让服务器配置文件和文档同步）</strong></p>
<p><strong>/home/mes/mydata/mysql</strong>  数据和配置文件在这个目录下面</p>
<div class="language-docker line-numbers-mode" data-ext="docker"><pre v-pre class="language-docker"><code>docker pull mysql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2、使用-p-创建多级目录-即-mydata-目录下创建-mysql-目录-mysql-目录下又创建-log-、data-、conf-三个目录" tabindex="-1"><a class="header-anchor" href="#_2、使用-p-创建多级目录-即-mydata-目录下创建-mysql-目录-mysql-目录下又创建-log-、data-、conf-三个目录" aria-hidden="true">#</a> 2、使用 <code v-pre>-p</code> 创建多级目录，即 <code v-pre>mydata</code> 目录下创建 <code v-pre>mysql</code> 目录， mysql 目录下又创建 <code v-pre>log 、data 、conf</code> 三个目录</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /mydata/mysql/log
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#启动容器,不用docker-compose命令创建</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">chmod</span> <span class="token number">777</span> conf data log <span class="token comment">#给三个文件夹权限</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_3、创建my-cnf" tabindex="-1"><a class="header-anchor" href="#_3、创建my-cnf" aria-hidden="true">#</a> 3、创建my.cnf</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4、创建docker-compose-yml文件-正式环境数据库使用的数这种方式部署" tabindex="-1"><a class="header-anchor" href="#_4、创建docker-compose-yml文件-正式环境数据库使用的数这种方式部署" aria-hidden="true">#</a> 4、创建docker-compose.yml文件（<strong>正式环境数据库使用的数这种方式部署</strong>）</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">'3'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">docker-compose</span> up <span class="token parameter variable">-d</span> <span class="token comment">#启动docker-compose.yml </span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_5、连接mysql" tabindex="-1"><a class="header-anchor" href="#_5、连接mysql" aria-hidden="true">#</a> 5、连接mysql</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 查看docker容器</span>
...
<span class="token builtin class-name">exit</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6、mysql报错-host-is-not-allowed-to-connect-to-this-mysql-server-解决办法" tabindex="-1"><a class="header-anchor" href="#_6、mysql报错-host-is-not-allowed-to-connect-to-this-mysql-server-解决办法" aria-hidden="true">#</a> 6、<a href="https://www.cnblogs.com/xjmm/p/12518798.html" target="_blank" rel="noopener noreferrer">MySQL报错&quot;Host ' is not allowed to connect to this MySQL server&quot;<ExternalLinkIcon/></a> 解决办法</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 进入容器，连接mysql，选择mysql库，查询表</span>
...
flush privileges<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="复制容器文件到宿主机" tabindex="-1"><a class="header-anchor" href="#复制容器文件到宿主机" aria-hidden="true">#</a> 复制容器文件到宿主机</h5>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#把容器指定位置的东西复制出来 </span>
