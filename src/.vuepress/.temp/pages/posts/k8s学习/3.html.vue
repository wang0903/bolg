<template><div><h1 id="kubesphere实现流水线部署" tabindex="-1"><a class="header-anchor" href="#kubesphere实现流水线部署" aria-hidden="true">#</a> kubesphere实现流水线部署</h1>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>Your Kubernetes control-plane has initialized successfully<span class="token operator">!</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、pod操作" tabindex="-1"><a class="header-anchor" href="#三、pod操作" aria-hidden="true">#</a> 三、pod操作</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_3-2、查看所有pod" tabindex="-1"><a class="header-anchor" href="#_3-2、查看所有pod" aria-hidden="true">#</a> 3.2、查看所有pod</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl get pods --all-namespaces
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="四、kubesphere相关基础配置" tabindex="-1"><a class="header-anchor" href="#四、kubesphere相关基础配置" aria-hidden="true">#</a> 四、kubesphere相关基础配置</h2>
<h3 id="_4-1、配置镜像拉取和推送镜像到" tabindex="-1"><a class="header-anchor" href="#_4-1、配置镜像拉取和推送镜像到" aria-hidden="true">#</a> 4.1、配置镜像拉取和推送镜像到</h3>
<p>路径:/etc/docker/daemon.json 如果没有这个文件就新建，需要在所有节点上设置</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2、重启docker" tabindex="-1"><a class="header-anchor" href="#_4-2、重启docker" aria-hidden="true">#</a> 4.2、重启docker</h3>
<p>重载守护进程，以便它读取新的配置：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>重启Docker服务使新的配置生效：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>验证Docker是否正常运行</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> systemctl status <span class="token function">docker</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-3、kubesphere配置私有镜像仓库" tabindex="-1"><a class="header-anchor" href="#_4-3、kubesphere配置私有镜像仓库" aria-hidden="true">#</a> 4.3、kubesphere配置私有镜像仓库</h3>
<h4 id="_1-1-准备工作" tabindex="-1"><a class="header-anchor" href="#_1-1-准备工作" aria-hidden="true">#</a> 1.1 准备工作</h4>
<p>您需要创建一个企业空间、一个项目和一个用户（例如 demo4project）。该用户必须已邀请至该项目，并具有 operator 角色</p>
<p><img src="@source/.vuepress/public/assets/images/kubesphere/1.png" alt="第一步" loading="lazy">
<img src="@source/.vuepress/public/assets/images/kubesphere/2.png" alt="第二步" loading="lazy"></p>
<h4 id="_1-2-创建保密字典" tabindex="-1"><a class="header-anchor" href="#_1-2-创建保密字典" aria-hidden="true">#</a> 1.2 创建保密字典</h4>
<p>创建工作负载、服务、任务或定时任务时，除了从公共仓库选择镜像，您还可以从私有仓库选择镜像。要使用私有仓库中的镜像，您必须先为私有仓库创建保密字典，以便在 KubeSphere 中集成该私有仓库。</p>
<h4 id="_1-2-1-步骤-1-进入保密字典页面" tabindex="-1"><a class="header-anchor" href="#_1-2-1-步骤-1-进入保密字典页面" aria-hidden="true">#</a> 1.2.1 步骤 1：进入保密字典页面</h4>
<p>以 demo4project 用户登录 KubeSphere Web 控制台并进入项目，在左侧导航栏中选择配置下的保密字典，然后点击创建。</p>
<figure><img src="@source/.vuepress/public/assets/images/kubesphere/3.png" alt="alt text" tabindex="0" loading="lazy"><figcaption>alt text</figcaption></figure>
<h4 id="_1-2-2-步骤-2-配置基本信息" tabindex="-1"><a class="header-anchor" href="#_1-2-2-步骤-2-配置基本信息" aria-hidden="true">#</a> 1.2.2 步骤 2：配置基本信息</h4>
<p>设置保密字典的名称（例如 dockerhub），然后点击下一步。</p>
<blockquote>
<p>您可以在对话框右上角启用编辑 YAML 来查看保密字典的 YAML 清单文件，并通过直接编辑清单文件来创建保密字典。您也可以继续执行后续步骤在控制台上创建保密字典。</p>
</blockquote>
<figure><img src="@source/.vuepress/public/assets/images/kubesphere/4.png" alt="alt text" tabindex="0" loading="lazy"><figcaption>alt text</figcaption></figure>
<h4 id="_1-2-3-步骤-3-配置镜像仓库信息" tabindex="-1"><a class="header-anchor" href="#_1-2-3-步骤-3-配置镜像仓库信息" aria-hidden="true">#</a> 1.2.3 步骤 3：配置镜像仓库信息</h4>
<p>将类型设置为 镜像仓库信息。要在创建应用负载时使用私有仓库中的镜像，您需要配置以下字段：</p>
<p>仓库地址：镜像仓库的地址，其中包含创建应用负载时需要使用的镜像。
用户名：登录镜像仓库所需的用户名。
密码：登录镜像仓库所需的密码。
邮箱（可选）：您的邮箱地址。</p>
<figure><img src="@source/.vuepress/public/assets/images/kubesphere/5.png" alt="alt text" tabindex="0" loading="lazy"><figcaption>alt text</figcaption></figure>
<h4 id="_1-2-3-1-添加-docker-hub-仓库" tabindex="-1"><a class="header-anchor" href="#_1-2-3-1-添加-docker-hub-仓库" aria-hidden="true">#</a> 1.2.3.1 添加 Docker Hub 仓库</h4>
<p>在 Docker Hub 上添加镜像仓库之前，您需要注册一个 Docker Hub 帐户。在保密字典设置页面，将仓库地址设置为 docker.io，将用户名和密码分别设置为您的 Docker ID 和密码，然后点击验证以检查地址是否可用。</p>
<p>点击创建。保密字典创建后会显示在保密字典界面。</p>
<h4 id="_1-2-3-2-添加-harbor-镜像仓库" tabindex="-1"><a class="header-anchor" href="#_1-2-3-2-添加-harbor-镜像仓库" aria-hidden="true">#</a> 1.2.3.2 添加 Harbor 镜像仓库</h4>
<p>Harbor 是一个开源的可信云原生仓库项目，用于对内容进行存储、签名和扫描。通过增加用户经常需要的功能，例如安全、身份验证和管理，Harbor 扩展了开源的 Docker Distribution。Harbor 使用 HTTP 和 HTTPS 为仓库请求提供服务。</p>
<h4 id="http" tabindex="-1"><a class="header-anchor" href="#http" aria-hidden="true">#</a> HTTP</h4>
<p>您需要修改集群中所有节点的 Docker 配置。例如，如果外部 Harbor 仓库的 IP 地址为 http://192.168.0.99，您需要在 /etc/systemd/system/docker.service.d/docker-options.conf 文件中增加 --insecure-registry=192.168.0.99 标签。</p>
...
Docker 守护进程需要 --insecure-registry 标签才能与不安全的仓库通信。有关该标签的更多信息，请参阅 Docker 官方文档。</p>
</blockquote>
<p>2、重新加载配置文件并重启 Docker。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code> <span class="token function">sudo</span> systemctl daemon-reload
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> systemctl restart <span class="token function">docker</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>3、在 KubeSphere 控制台上进入创建保密字典的数据设置页面，将类型设置为镜像仓库信息，将仓库地址设置为您的 Harbor IP 地址，并设置用户名和密码。</p>
<blockquote>
<p>如需使用 Harbor 域名而非 IP 地址，您需要在集群中配置 CoreDNS 和 nodelocaldns。
下一篇文章中会介绍，如何集成使用Harobr域名的镜像仓库</p>
</blockquote>
<p>4、点击创建。保密字典创建后会显示在保密字典页面。有关保密字典创建后如何编辑保密字典。</p>
<h4 id="https" tabindex="-1"><a class="header-anchor" href="#https" aria-hidden="true">#</a> HTTPS</h4>
<p>有关如何集成基于 HTTPS 的 Harbor 仓库，请参阅 Harbor 官方文档。请确保您已使用 docker login 命令连接到您的 Harbor 仓库。</p>
<h4 id="_1-3-使用镜像仓库" tabindex="-1"><a class="header-anchor" href="#_1-3-使用镜像仓库" aria-hidden="true">#</a> 1.3 使用镜像仓库</h4>
<p>如果您已提前创建了私有镜像仓库的保密字典，您可以选择私有镜像仓库中的镜像。例如，创建部署时，您可以在添加容器页面点击镜像下拉列表选择一个仓库，然后输入镜像名称和标签使用镜像。</p>
<h4 id="_1-4-快速部署-harbor-v2-3-1-https-访问" tabindex="-1"><a class="header-anchor" href="#_1-4-快速部署-harbor-v2-3-1-https-访问" aria-hidden="true">#</a> 1.4 快速部署 Harbor v2.3.1 https 访问</h4>
<p><a href="https://shenhonglei.blog.csdn.net/article/details/124183802" target="_blank" rel="noopener noreferrer">https 访问-快速部署 Harbor v2.3.1<ExternalLinkIcon/></a></p>
<h2 id="五、流水线安装" tabindex="-1"><a class="header-anchor" href="#五、流水线安装" aria-hidden="true">#</a> 五、流水线安装</h2>
<h3 id="_1、流水线代码" tabindex="-1"><a class="header-anchor" href="#_1、流水线代码" aria-hidden="true">#</a> 1、流水线代码</h3>
