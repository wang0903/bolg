<template><div><h1 id="rke2安装" tabindex="-1"><a class="header-anchor" href="#rke2安装" aria-hidden="true">#</a> RKE2安装</h1>
<h2 id="中文文档地址" tabindex="-1"><a class="header-anchor" href="#中文文档地址" aria-hidden="true">#</a> 中文文档地址</h2>
<p>https://docs.rancher.cn/docs/rke2/install/quickstart/_index</p>
<h2 id="github地址" tabindex="-1"><a class="header-anchor" href="#github地址" aria-hidden="true">#</a> GitHub地址</h2>
<p>https://github.com/rancher/rke2/</p>
<h2 id="国内镜像网站" tabindex="-1"><a class="header-anchor" href="#国内镜像网站" aria-hidden="true">#</a> 国内镜像网站</h2>
<p>https://docker.aityp.com/</p>
<h2 id="修改时区" tabindex="-1"><a class="header-anchor" href="#修改时区" aria-hidden="true">#</a> 修改时区</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> timedatectl set-timezone Asia/Shanghai
<span class="token comment"># 查看是否成功</span>
timedatectl
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="设置时间同步-小集群" tabindex="-1"><a class="header-anchor" href="#设置时间同步-小集群" aria-hidden="true">#</a> 设置时间同步(小集群)</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#更新包</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="设置主机名" tabindex="-1"><a class="header-anchor" href="#设置主机名" aria-hidden="true">#</a> 设置主机名</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#编辑以下文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="mastrs节点安装" tabindex="-1"><a class="header-anchor" href="#mastrs节点安装" aria-hidden="true">#</a> mastrs节点安装</h2>
<blockquote>
<p>下载离线包</p>
</blockquote>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>https://github.com/rancher/rke2/tags
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="下载安装脚本" tabindex="-1"><a class="header-anchor" href="#下载安装脚本" aria-hidden="true">#</a> 下载安装脚本</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">curl</span> <span class="token parameter variable">-sfL</span> https://rancher-mirror.rancher.cn/rke2/install.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="将离线包放到这目录下" tabindex="-1"><a class="header-anchor" href="#将离线包放到这目录下" aria-hidden="true">#</a> 将离线包放到这目录下</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /var/lib/rancher/rke2/agent/images/
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> systemctl restart rke2-server
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="查看服务状态" tabindex="-1"><a class="header-anchor" href="#查看服务状态" aria-hidden="true">#</a> 查看服务状态</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> systemctl status rke2-server <span class="token parameter variable">-l</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="验证集群是否成功启动" tabindex="-1"><a class="header-anchor" href="#验证集群是否成功启动" aria-hidden="true">#</a> 验证集群是否成功启动</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># RKE2 会在 /etc/rancher/rke2/rke2.yaml 生成 kubeconfig：</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">echo</span> <span class="token string">'export PATH=$PATH:/var/lib/rancher/rke2/bin'</span> <span class="token operator">|</span> <span class="token function">sudo</span> <span class="token function">tee</span> <span class="token parameter variable">-a</span> /etc/profile.d/rke2.sh
...
kubectl get nodes
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="启动日志查看" tabindex="-1"><a class="header-anchor" href="#启动日志查看" aria-hidden="true">#</a> 启动日志查看</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> journalctl <span class="token parameter variable">-u</span> rke2-server <span class="token parameter variable">-f</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="worker节点" tabindex="-1"><a class="header-anchor" href="#worker节点" aria-hidden="true">#</a> worker节点</h2>
<h3 id="下载安装脚本-1" tabindex="-1"><a class="header-anchor" href="#下载安装脚本-1" aria-hidden="true">#</a> 下载安装脚本</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">curl</span> <span class="token parameter variable">-sfL</span> https://rancher-mirror.rancher.cn/rke2/install.sh <span class="token parameter variable">-o</span> install.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="下载离线镜像-并将包放到指定目录下" tabindex="-1"><a class="header-anchor" href="#下载离线镜像-并将包放到指定目录下" aria-hidden="true">#</a> 下载离线镜像，并将包放到指定目录下</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /var/lib/rancher/rke2/agent/images/
<span class="token function">sudo</span> <span class="token function">mv</span> rke2-images.linux-amd64.tar.zst /var/lib/rancher/rke2/agent/images/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="配置-rke2-agent-服务" tabindex="-1"><a class="header-anchor" href="#配置-rke2-agent-服务" aria-hidden="true">#</a> 配置 rke2-agent 服务</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /etc/rancher/rke2/
<span class="token function">vim</span> /etc/rancher/rke2/config.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="填写内容" tabindex="-1"><a class="header-anchor" href="#填写内容" aria-hidden="true">#</a> 填写内容</h3>
<p><code v-pre>本地也必须用 *https://&lt;master-ip&gt;:9345*，因为 RKE2 的 server 端默认就是用 TLS 起的 9345 端口。</code></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>server: https://masters:9345 
token: K104ae9acd991afd22246e01e5080b711a4198f4d92f3b858ebb1db99b8a6b2f7ed::server:548edec63f78e4f97e7295f43d64de63
node-name: node01
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="获取token" tabindex="-1"><a class="header-anchor" href="#获取token" aria-hidden="true">#</a> 获取token</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">cat</span> /var/lib/rancher/rke2/server/node-token
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="开机自启" tabindex="-1"><a class="header-anchor" href="#开机自启" aria-hidden="true">#</a> 开机自启</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> systemctl <span class="token builtin class-name">enable</span> rke2-agent.service
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="启动-1" tabindex="-1"><a class="header-anchor" href="#启动-1" aria-hidden="true">#</a> 启动</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> systemctl start rke2-agent
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="查看启动日志" tabindex="-1"><a class="header-anchor" href="#查看启动日志" aria-hidden="true">#</a> 查看启动日志</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> journalctl <span class="token parameter variable">-u</span> rke2-agent <span class="token parameter variable">-f</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="安装-cert-manager" tabindex="-1"><a class="header-anchor" href="#安装-cert-manager" aria-hidden="true">#</a> 安装 cert-manager</h2>
<blockquote>
<p><strong>HTTPS 证书的申请、续签、分发都交给 cert-manager 来处理</strong>
<strong>cert-manager 自动处理 ACME 协议</strong>，通过 Ingress (nginx) 完成域名验证，然后把证书存到 Secret 里。<strong>邮箱</strong>：在 <code v-pre>ClusterIssuer</code> 里配置，用于向 Let’s Encrypt 注册账号，<strong>也能接收证书过期提醒邮件</strong>。
<strong>证书有效期</strong>：Let’s Encrypt 默认 90 天，cert-manager 会在过期前 30 天自动续签。</p>
<p><strong>自动化程度</strong>：证书创建 → 绑定 Ingress → 自动续签，全部无人值守。</p>
</blockquote>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token comment">#离线下载，根据自己的版本下载</span>
...
<p>https://k8slens.dev/</p>
<h2 id="安装rancher管理界面-web" tabindex="-1"><a class="header-anchor" href="#安装rancher管理界面-web" aria-hidden="true">#</a> 安装rancher管理界面(WEB)</h2>
<h3 id="官网-文档" tabindex="-1"><a class="header-anchor" href="#官网-文档" aria-hidden="true">#</a> 官网(文档)</h3>
<p>https://ranchermanager.docs.rancher.com/zh/</p>
<h3 id="国内镜像网站-1" tabindex="-1"><a class="header-anchor" href="#国内镜像网站-1" aria-hidden="true">#</a> 国内镜像网站</h3>
<p>https://docker.aityp.com/</p>
<h3 id="安装helm" tabindex="-1"><a class="header-anchor" href="#安装helm" aria-hidden="true">#</a> 安装helm</h3>
<p><code v-pre>版本下载</code>：https://github.com/helm/helm/tags</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">wget</span> https://get.helm.sh/helm-v3.18.6-linux-amd64.tar.gz
...
helm version
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="添加仓库" tabindex="-1"><a class="header-anchor" href="#添加仓库" aria-hidden="true">#</a> 添加仓库：</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>helm repo <span class="token function">add</span> rancher-stable https://rancher-mirror.rancher.cn/server-charts/stable
helm repo updatehelm repo <span class="token function">add</span> stable https://charts.helm.sh/stable
helm repo update
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装rancher-nodeport方式连接" tabindex="-1"><a class="header-anchor" href="#安装rancher-nodeport方式连接" aria-hidden="true">#</a> 安装rancher(NodePort方式连接)</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>helm <span class="token function">install</span> rancher rancher-stable/rancher <span class="token punctuation">\</span>
...
<p><code v-pre>-set ingress.enabled=false \ #禁用 Ingress，不创建 Ingress 资源。</code></p>
<p><code v-pre>--set rancherImage=registry.cn-hangzhou.aliyuncs.com/rancher/rancher \ #用阿里云的镜像</code></p>
<p><code v-pre>--set bootstrapPassword=admin \ #默认密码</code></p>
<p><code v-pre>安装前先用一台能连通docker的系统，下载rancher/shell和rancher/rancher-webhook 操作请看下面：</code></p>
</blockquote>
<h3 id="用docker下载指定容器" tabindex="-1"><a class="header-anchor" href="#用docker下载指定容器" aria-hidden="true">#</a> 用docker下载指定容器</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> pull rancher/shell:v0.4.1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="创建values-yaml" tabindex="-1"><a class="header-anchor" href="#创建values-yaml" aria-hidden="true">#</a> 创建values.yaml</h3>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token comment"># values.yaml</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="添加加速镜像" tabindex="-1"><a class="header-anchor" href="#添加加速镜像" aria-hidden="true">#</a> 添加加速镜像</h3>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>mirrors<span class="token operator">:</span>
...
<p><code v-pre>mirrors</code>：把 <code v-pre>docker.io</code> 的镜像请求重定向到国内镜像源。</p>
<p><code v-pre>configs</code>：可选，填入私有仓库认证信息（如果有）。</p>
</blockquote>
<h3 id="拉取镜像" tabindex="-1"><a class="header-anchor" href="#拉取镜像" aria-hidden="true">#</a> 拉取镜像</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> /var/lib/rancher/rke2/bin/ctr <span class="token parameter variable">-n</span> k8s.io images pull registry.cn-hangzhou.aliyuncs.com/rancher/shell:v0.4.1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="helm命令使用" tabindex="-1"><a class="header-anchor" href="#helm命令使用" aria-hidden="true">#</a> helm命令使用</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#查看某个库的chart</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="kubectl命令使用" tabindex="-1"><a class="header-anchor" href="#kubectl命令使用" aria-hidden="true">#</a> kubectl命令使用</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 确认 Pod 已经清理干净</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="获取权限" tabindex="-1"><a class="header-anchor" href="#获取权限" aria-hidden="true">#</a> 获取权限</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token parameter variable">-p</span> ~/.kube
...
<span class="token builtin class-name">source</span> ~/.bashrc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="安装argo-cd" tabindex="-1"><a class="header-anchor" href="#安装argo-cd" aria-hidden="true">#</a> 安装Argo CD</h2>
<h3 id="下载安装文件" tabindex="-1"><a class="header-anchor" href="#下载安装文件" aria-hidden="true">#</a> 下载安装文件</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>https://raw.githubusercontent.com/argoproj/argo-cd/v3.0.6/manifests/install.yaml
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装运行" tabindex="-1"><a class="header-anchor" href="#安装运行" aria-hidden="true">#</a> 安装运行</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="获取密码" tabindex="-1"><a class="header-anchor" href="#获取密码" aria-hidden="true">#</a> 获取密码</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#取初始 admin 密码（登录之后记得改密码）</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="搭建-nfs-服务器" tabindex="-1"><a class="header-anchor" href="#搭建-nfs-服务器" aria-hidden="true">#</a> 搭建 NFS 服务器</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 以 Ubuntu 为例</span>
<span class="token function">sudo</span> <span class="token function">apt</span> update
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="master节点安装" tabindex="-1"><a class="header-anchor" href="#master节点安装" aria-hidden="true">#</a> master节点安装</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#用浏览器安装</span>
...
<p>这个 <code v-pre>rbac.yaml</code> 是 NFS Subdir External Provisioner 用来申请权限（RBAC，Role-Based Access Control）的一段配置。它定义了 ServiceAccount、ClusterRole、Role、ClusterRoleBinding、RoleBinding 等资源，以便 provisioner 有权限执行必要的操作。</p>
</blockquote>
<h3 id="运行" tabindex="-1"><a class="header-anchor" href="#运行" aria-hidden="true">#</a> 运行</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#运行权限</span>
kubectl apply <span class="token parameter variable">-f</span> rbac.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="给操作权限" tabindex="-1"><a class="header-anchor" href="#给操作权限" aria-hidden="true">#</a> 给操作权限</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="编写deployment-yaml" tabindex="-1"><a class="header-anchor" href="#编写deployment-yaml" aria-hidden="true">#</a> 编写deployment.yaml</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="创建一个-storageclass" tabindex="-1"><a class="header-anchor" href="#创建一个-storageclass" aria-hidden="true">#</a> 创建一个 StorageClass</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="创建pvc测试案例" tabindex="-1"><a class="header-anchor" href="#创建pvc测试案例" aria-hidden="true">#</a> 创建PVC测试案例</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="storageclass、pvc、pv关系图" tabindex="-1"><a class="header-anchor" href="#storageclass、pvc、pv关系图" aria-hidden="true">#</a> StorageClass、PVC、PV关系图</h3>
<div class="language-perl line-numbers-mode" data-ext="perl"><pre v-pre class="language-perl"><code>         ┌─────────────────────┐
         │   StorageClass      │
   ...
   Provisioner 根据 StorageClass 创建真实存储
     ...
     PVC 绑定 PV，Pod 通过 PVC 使用存储
         ...
         └─────────────────────┘
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="执行" tabindex="-1"><a class="header-anchor" href="#执行" aria-hidden="true">#</a> 执行</h3>
...
<h3 id="官网" tabindex="-1"><a class="header-anchor" href="#官网" aria-hidden="true">#</a> 官网</h3>
<p>https://metallb.io/</p>
<h3 id="添加仓库helm" tabindex="-1"><a class="header-anchor" href="#添加仓库helm" aria-hidden="true">#</a> 添加仓库helm</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>helm repo <span class="token function">add</span> metallb https://metallb.github.io/metallb
helm repo update
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 安装 metallb 到 metallb-system 命名空间</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="配置-ipaddresspool" tabindex="-1"><a class="header-anchor" href="#配置-ipaddresspool" aria-hidden="true">#</a> 配置 IPAddressPool</h3>
<blockquote>
<p>新建一个 <code v-pre>IPAddressPool</code>，告诉 MetalLB 可以用哪些 IP 来分配给 <code v-pre>Service type=LoadBalancer</code></p>
</blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="配置-l2advertisement" tabindex="-1"><a class="header-anchor" href="#配置-l2advertisement" aria-hidden="true">#</a> 配置 L2Advertisement</h3>
<blockquote>
<p>让 MetalLB 广播这段 IP</p>
</blockquote>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> metallb.io/v1beta1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="验证是否安装成功" tabindex="-1"><a class="header-anchor" href="#验证是否安装成功" aria-hidden="true">#</a> 验证是否安装成功</h3>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> v1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查看ip是否分配成功" tabindex="-1"><a class="header-anchor" href="#查看ip是否分配成功" aria-hidden="true">#</a> 查看IP是否分配成功</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl get svc test-nginx
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="成功分配" tabindex="-1"><a class="header-anchor" href="#成功分配" aria-hidden="true">#</a> 成功分配</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mes@masters:~$ kubectl get svc test-nginx
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="删除测试" tabindex="-1"><a class="header-anchor" href="#删除测试" aria-hidden="true">#</a> 删除测试</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl delete <span class="token parameter variable">-f</span> test-nginx.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="应用部署-springboot-vue" tabindex="-1"><a class="header-anchor" href="#应用部署-springboot-vue" aria-hidden="true">#</a> 应用部署(springboot+vue)</h2>
<h3 id="部署的流程图" tabindex="-1"><a class="header-anchor" href="#部署的流程图" aria-hidden="true">#</a> 部署的流程图</h3>
<div class="language-perl line-numbers-mode" data-ext="perl"><pre v-pre class="language-perl"><code>   ┌──────────────┐
      │   Developer  │
